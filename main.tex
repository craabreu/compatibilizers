...
%\section*{ToC text}
%Our DPD simulations show that the copolymer microstructural properties have a decisive %impact on the interaction and mesophases generated in the mixing process with %non-compatible homopolymers. So that the microstructure control methods, derived from %polymer reaction engineering or from polymer purification, are important for to design and %performance of these blends.
%
%\section*{ToC Figure}
%\includegraphics[width=6.5in]{ToCfigure}
